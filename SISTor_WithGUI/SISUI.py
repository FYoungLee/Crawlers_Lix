...
class SISMainWindow(QWidget):
    ...
    def update_progress(self):
        if self.max_topics == 0:
            ...
            cur_pro = self.current_progress*100/self.max_topics
            self.progress_bar.setValue(cur_pro)
        self.progress_label.setText('{}/{}'.format(self.current_progress, self.max_topics))

    def progress_received(self, n):
        self.current_progress += n
        self.update_progress()

    def topics_quantity_received(self, n):
        self.max_topics += n
        self.update_progress()
